...
const {body,validator} = require('express-validator/check');
...
exports.genre_create_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // There are erors. Render the form again with sanitized values/error messages.
